...
#define REDUCE_CONTIGUOUS (it.stride == 1 && ((it.ndim_m2 < 0) \
    || (C_CONTIGUOUS(a) || F_CONTIGUOUS(a))))
#define ONE_CONTIGUOUS (it.stride == 1 && ((it.ndim_m2 >= 0) && \
    ((C_CONTIGUOUS(a) || F_CONTIGUOUS(a)) && (it.axis == axis))))
#define ONE_TRANSPOSE(dtype) ((it.ndim_m2 == 0) && \
    it.astrides[it.ndim_m2] == sizeof(dtype) && \
